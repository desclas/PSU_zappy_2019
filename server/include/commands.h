...
int				find_tile(client_t *emitter,
					client_t *receiver);
void				sum_x_equals_zero(int sum_y, int *x1, int *y1);
void				sum_y_equals_zero(int sum_y, int *x1, int *y1);
void				sums_differ_from_zero(int sum_x, int sum_y,
					int *x1, int *y1);
int				is_smallest_distance_1
					(float distance_to_compare,
					float distance, int *x1, int *y1);
int				is_smallest_distance_2
					(float distance_to_compare,
					float distance, int *x1, int *y1);
int				is_smallest_distance_3
					(float distance_to_compare,
					float distance, int *x1, int *y1);
int				is_smallest_distance_4
					(float distance_to_compare,
					float distance, int *x1, int *y1);
int				is_smallest_distance_5
					(float distance_to_compare,
					float distance, int *x1, int *y1);
...
int				add_cmd_to_list(client_t *client, char *cmd,
					commands_f func, int cmd_time);
commands_t			*delete_first_cmd_from_list(
					commands_t *cmd_list);
